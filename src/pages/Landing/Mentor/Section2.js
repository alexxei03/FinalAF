    ...
    return (
        <section className="sct2">
            <div className="container">
                <div className="sct2-h1">{t('faq.title', 'Часто задаваемые вопросы')}</div>
                <div className="sct2-columns">
                    <div className="column1">
                        <div className="sct2-elems">
                            {faqData.map((faq, index) => (
                                <div
                                    key={index}
                                    className={`sct2-el ${activeFAQ === index ? 'active' : ''}`}
                                    onClick={() => setActiveFAQ(index)}
                                >
                                    <div className="sct2-el1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <circle cx="12" cy="12" r="12" fill="#B2D1FF" />
                                        </svg>
                                    </div>
                                    <div className="el-text">{faq.question}</div>
                                    <div className="sct2-el2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                            <path
                                                d="M8 4L16 12L8 20"
                                                stroke="#B2D1FF"
                    ...
                    <div className="column2">
                        <div className="col2-card">
                            ...
                            <div className="col2-h2">{faqData[activeFAQ].answer}</div>
                        </div>
                    </div>
                </div>
            </div>
...
export default LandingMentorSection2;